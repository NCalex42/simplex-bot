...
public class PromoteBotConstants {

    public static final String CFG_FILE_NAME = "promote-bot.txt";
    ...
    static final String CONFIG_MIN_WAIT_TIME_DAYS = "min-wait-time-days-per-member";
